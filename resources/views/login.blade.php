      ...
      <div class="container-scroller container-main-wrapper">
         ...
         <div class="page-header">
            <div class="app" style="height: 600px !important;">
               ...
               @endif
               <form class="form-wrapper" method="POST" action="{{ url('/login') }}">
                  {{ csrf_field() }}
                  <header>
                     <?php if(isset($data->logo)){?>
                     <img src="{{asset('productimg')}}<?php echo '/'.$data->logo;?>" style="width:200px;height:100px;">
                     <?php }else{?>
                     <img src="{{asset('productimg')}}/logo.PNG" style="width:200px;height:100px;">
                     <?php }?>
                  </header>
                  <div class="inputs">
                     ...
                     <button style="margin-top:67px;margin-bottom: 15px;">Continue</button>
                     <p>Don't have an account? <a href="{{ route('admin.register') }}">Sign Up</a></p>
                     @if($adminDetails->isEmpty())
                     <p>Register as<a href="{{ route('admindata') }}"> Admin</a></p>
                     @else
                     @endif
                  </div>
               </form>
