...
.buttonipdata2 {background-color: skyblue;} 
</style>
...
<link href="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.5.1/min/dropzone.min.css" rel="stylesheet" />
 ...
 <div class="main-panel">
          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Update Product Price</li>
              </ol>
            </nav>
          </div>
        <button class="buttonipdata buttonipdata2"><a href="{{ url('product')}}">Product</a></button>
	<div class="row">
            <div class="row">
    ...
    <div class="card bg-light mt-3 col-md-12">
        ...
        <div class="card-body">
            <form action="{{ route('importproductpricedata')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
