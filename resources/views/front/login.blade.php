...
@include('front.header')
   ...
   <section>
       ...
       <form action="{{ route('front.logindata') }}" style="border:1px solid #ccc" method="POST">
            {{ csrf_field() }}
            <div class="container">
                ...
                <input type="text" placeholder="Enter Mobile Number" name="mobiledata" required>
            
                <label for="psw"><b>Password</b></label>
                <input type="password" placeholder="Enter Password" name="paasword" required>
            
                
                
                
                
                <p>Don't have an account? <a href="{{route('front.register')}}" style="color:dodgerblue">Sign Up</a>.</p>
            
                <div class="clearfix">
                  
                  <button type="submit" class="signupbtn float-right">Log In</button>
                </div>
            </div>
        </form>
        </div>
