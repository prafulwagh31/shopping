                  ...
                  <div class="col-12">
                    <table id="order-listing" class="table">
                      ...
                      <thead>
                        ...
                        <tbody>
                        <?php $i = 1;foreach($proposaldata as $proposaldataval) {?>
                        <tr>
                           <td><?php echo $i;?></td>

                           
                           
                           <td><a href="{{ route('proposallist',$proposaldataval->id)}}"><?php echo $proposaldataval->proposal_ref_id;?></a></td>
                           <td><?php echo $proposaldataval->customer_name;?></td>
                           <td><?php echo $proposaldataval->proposal_date;?>
                           </td>
                           <td><?php echo $proposaldataval->payment_term;?>
                           </td>
                            <td><?php echo $proposaldataval->payment_type;?></td>
                             <td><?php echo $proposaldataval->source;?></td>
                             
                             <td><a href="{{url('/propdataedit/'.$proposaldataval->id)}}"><i class="fa fa-edit"></i></a>
                          <a href="{{url('/propdatadelete/'.$proposaldataval->id)}}"><i class="fa fa-trash"></i></a>
                          </td>
