...
define('MCC', '5137'); 
define('RETURNURL', 'http://rasheedmohammed.com/shoppingcat/ISGPAY/success-response.php'); 
define('GATEWAYURL', 'https://sandbox.isgpay.com/ISGPay/request.action'); 
// define('STATUSURL', 'https://sandbox.kopayments.com:8446/TransactionRoute/Status'); 
